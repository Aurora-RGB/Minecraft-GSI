...
class GameStateProvider1Dot18 : GameStateProvider {
    ...
    private fun updateWorldNode() {
        ...
        worldNode.dimensionID = when (dimension.effectsLocation()) {
            DimensionType.NETHER_LOCATION.location() -> -1
            DimensionType.OVERWORLD_LOCATION.location() -> 2
            DimensionType.END_LOCATION.location() -> 1
            else -> 0
        }
    }
    ...
    private fun updatePlayerNode() {
        ...
        playerNode.isRidingHorse = player.isRidingJumpable
